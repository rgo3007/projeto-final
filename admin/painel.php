    ...
    <body class="painel">
        ...
        <header id="navadmin">
            <div class="content">
                ...
                <ul class="systema_nav radius">
                    <li class="username">Olá <?= $userlogin['nome']; ?> </li>
                ...
                <nav>
                    ...
                    <ul class="menu">
                        <li class="li<?php if (in_array('posts', $linkto)) echo ' active'; ?>"><a class="opensub" onclick="return false;" href="#">Usuário</a>
                            <ul class="sub">
                                <li><a href="painel.php?exe=usuario/create">Cadastrar</a></li>
                                <li><a href="painel.php?exe=usuario/users">Listar / Editar </a></li>
                            </ul>
                        </li>

                        <li class="li<?php if (in_array('categories', $linkto)) echo ' active'; ?>"><a class="opensub" onclick="return false;" href="#">Turma</a>
                            <ul class="sub">
                                <li><a href="painel.php?exe=turma/create">Criar Turma</a></li>
                                <li><a href="painel.php?exe=turma/users">Listar / Editar Editar</a></li>
                            </ul>
                        </li> 

                        <li class="li<?php if (in_array('empresas', $linkto)) echo ' active'; ?>"><a class="opensub" onclick="return false;" href="#">Agata</a>
                            <ul class="sub">
        ...
        <div id="painel">
            ...
            if (file_exists($includepatch)):
                ...
                SOSErro("<b>Erro ao incluir tela:</b> Erro ao incluir o controller /{$getexe}.php!", SOS_ERROR);
                echo "</div>";
            endif;
            ?>
        </div> <!-- painel -->
        ...
        <footer class="main_footer">
            <a href="http://www.colegiobrancadamota.com.br" target="_blank" title="Colégio Branca da Mota">&copy;Colégio Estadual Branca da Motta - Todos os Direitos Reservados</a>
        </footer>
